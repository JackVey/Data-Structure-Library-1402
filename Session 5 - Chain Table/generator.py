...
random_strings1 = [generate_random_string(8) + " " + str(random.randint(100_000_000, 999_999_999)) for i in range(100000)]
random_strings4 = [generate_random_string(8) + " " + str(random.randint(100_000_000, 999_999_999)) for i in range(10000)]
